...
## Quick start
- Serve locally: `python3 -m http.server 8765`
- Open: http://localhost:8765 in a browser of your choice

## What’s in this repo
- `index.html` — site entry
- `js/` — JavaScript sources (gallery, dogs, etc.)
...
<a href="https://github.com/pawsitive-ashoka/pawsitive-ashoka.github.io/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=pawsitive-ashoka/pawsitive-ashoka.github.io" />
</a>
